        ...
        <div className="mb-10 flex items-end justify-between gap-6">
          ...
          <div className="hidden gap-3 sm:flex">
            ...
            <button
              ...
              className="flex h-12 w-12 items-center justify-center rounded-full bg-[#064e3b] text-white transition-all duration-300 hover:bg-[#e85d04]"
            >
              <svg
                width="20"
                height="20"
        ...
        >
          {mostBookedServices.map((service, index) => (
            <motion.div
              ...
              className="group min-w-[280px] flex-[0_0_280px] snap-start overflow-hidden rounded-2xl border border-gray-200 bg-[#f8f9f7] shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl md:min-w-[calc((100%-72px)/4)] md:flex-[0_0_calc((100%-72px)/4)]"
            >
              {/* Image */}
              <div className="relative h-52 overflow-hidden">
                ...
                {/* Most Booked Badge */}
                <div className="absolute left-4 top-4 rounded-full bg-white/95 px-3 py-1 text-xs font-semibold text-[#064e3b] shadow-sm">
                  Most Booked
                </div>
              </div>
              ...
              {/* Content */}
              <div className="p-5">
                <p className="text-xs font-medium uppercase tracking-[0.15em] text-[#e85d04]">
                  {service.category}
                </p>

                <h3 className="mt-2 text-lg font-semibold text-[#064e3b]">
                  {service.title}
                </h3>
